<?php
namespace SDK\Library\Db\Hbase;
/**
...
use Extend\Protocol\Thrift\Exception\TApplicationException;
 ...
 * Class Hbase
 *
 * Phalcon Hbase Class for autoload
 *
 * @package Extend\Hbased
 */
final class Hbase
{
...
interface HbaseIf {
     ...
     *
     * @param ColumnDescriptor[] $columnFamilies list of column family descriptors
     *
     * @throws IOError
     ...
     * @param string $row row key
     *
     * @param Mutation[] $mutations list of mutation commands
     *
     ...
     * @param string $tableName name of table
     *
     * @param BatchMutation[] $rowBatches list of row batches
     *
     * @param array $attributes Mutation attributes
     *
     * @throws IOError
     ...
     *
     * @param TIncrement $increment The single increment to apply
     *
     * @throws IOError
     */
    public function increment(TIncrement $increment);
    /**
     * @param TIncrement[] $increments The list of increments
     *
     * @throws IOError
     */
     ...
     * @param string $tableName name of table
     *
     * @param TScan $scan Scan instance
     *
     ...
     * @throws IOError
     */
    public function scannerOpenWithScan($tableName, TScan $scan, array $attributes);
    /**
     ...
     * @param string $row row key
     *
     * @return TRegionInfo A TRegionInfo contains information about an HTable region.
     *
     * @throws IOError
     */
...
class HbaseClient implements HbaseIf {
    ...
    public function send_scannerOpenWithScan($tableName, TScan $scan, array $attributes)
    {
