...
namespace Extend\Protocol\Thrift\Serializer;

use Extend\Protocol\Thrift\Transport\TMemoryBuffer;
use Extend\Protocol\Thrift\Protocol\TBinaryProtocolAccelerated;
