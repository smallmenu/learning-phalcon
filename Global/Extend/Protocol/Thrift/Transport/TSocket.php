...
namespace Extend\Protocol\Thrift\Transport;

use Extend\Protocol\Thrift\Exception\TException;
use Extend\Protocol\Thrift\Exception\TTransportException;
use Extend\Protocol\Thrift\Factory\TStringFuncFactory;
